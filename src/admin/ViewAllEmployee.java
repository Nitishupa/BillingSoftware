...
public class ViewAllEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Email ID", "PhoneNO", "Password"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 410, 390));

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\NITISH\\Desktop\\Images\\add employee.jpg")); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
             ...
             )
        {
            while(rs.next())
            {
                ...
                phonno=rs.getString("phoneno");
               password=rs.getString("password");
               Object[]o={name,email,phonno,password};
